...
class Elimination:
    ...
    def __repr__(self):
        ...
        return f'{self.time}s : {self.eliminated} got {elim_type} by {self.eliminator} with {self.gun_type if Weapons(self.gun_type) == Weapons.MISSING else Weapons(self.gun_type)}'
